# DMT — Stato del progetto

## Cos'è l'app

**DMT** (nome provvisorio) è un'app Android per gestire le schede personaggio di **Dungeons & Dragons 5a edizione**, in sostituzione delle schede cartacee.
